...
const ContactForm = (props) => {
    ...
    return(
        // if true render supportForm otherwise, render the button
          <div>{props.visiblility ?  <SupportForm onClick={props.onClick} /> : <button onClick={props.onClick} className={styles.support}>
...
<div className={styles.formContainer}>
    <div className={styles.headingFormContainer}>
       <h2 className={styles.contact}><i onClick={props.onClick}class="arrow down icon"></i>Contact</h2> 
    </div>
    <div>
        <div>
